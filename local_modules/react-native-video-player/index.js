...
export default class VideoPlayer extends Component {
  constructor(props) {
    ...
    this.onSubOnPress = this.onSubOnPress.bind(this);
  ...
  onSubOnPress() {
    const isSubOn = !this.state.isSubOn;
    if (this.props.onSubOnPress) {
      this.props.onSubOnPress(isSubOn);
    }
    this.setState({
      isSubOn,
    });
  ...
  renderControls() {
    ...
    return (
      <View style={[styles.controls, customStyles.controls]}>
        ...
        <TouchableOpacity onPress={this.onSubOnPress} style={customStyles.controlButton}>
            <Icon
              style={[styles.extraControl, customStyles.controlIcon, {color: this.state.isSubOn ? 'white' : 'grey'}]}
              name="textsms"
              size={24}
            />
          </TouchableOpacity>
    ...
    return (
      <View style={customStyles.videoWrapper}>
        <Video
          ...
          selectedTextTrack={this.state.isSubOn ? this.props.selectedTextTrack : undefined}
          ref={p => { this.player = p }}
